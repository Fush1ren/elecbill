...
const LoginPelanggan = () => {
    ...
    */
    ...
    const [showInfoLogin, setShowInfoLogin] = useState(false);
    ...
    const buttonLogin = (e) => {
        e.preventDefault();
        setShowInfoLogin(!showInfoLogin);
    }
        ...
        <div className="flex bg-[#c7c7c5] text-black w-full bg- h-screen justify-center items-center ">
            <div className="w-[380px] h-[380px] bg-white rounded border justify-center items-center px-5 py-4">
                ...
                <div className="flex justify-center items-center gap-2">
                    ...
                    <button className="text-sm text-center hover:text-blue-500 hover:underline" onClick={buttonLogin}>
                        Info Login
                    </button>
                </div>
            </div>
            <div className={`${showInfoLogin === false ? 'hidden' : 'fixed inset-0 bg-gray-600 bg-opacity-50 flex flex-wrap content-center justify-center'}`}>
                <div className="bg-white p-6 rounded shadow-lg w-1/3">
                    <h2 className="text-xl mb-4 font-semibold">Info Login Pelanggan</h2>
                    <div className="mb-4">
                        <p className="block text-gray-700">Username : kusumah</p>
                        <p className="block text-gray-700">Password : 12345</p>
                    </div>
                    <div className="p-4">
                        <button className=" w-full border hover:bg-blue-700 bg-transparent border-blue-700 p-2" onClick={buttonLogin} >Close</button>
                    </div>
                </div>
            </div>
        </div>
